...
00000015  050000            add ax,0x0
00000018  8500              test [bx+si],ax
0000001A  2000              and [bx+si],al
0000001C  0000              add [bx+si],al
0000001E  0000              add [bx+si],al
00000020  1900              sbb [bx+si],ax
00000022  0000              add [bx+si],al
00000024  48                dec ax
00000025  0000              add [bx+si],al
00000027  005F5F            add [bx+0x5f],bl
0000002A  50                push ax
0000002B  41                inc cx
0000002C  47                inc di
0000002D  45                inc bp
...
000000D0  40                inc ax
000000D1  0F0000            sldt [bx+si]
000000D4  0100              add [bx+si],ax
000000D6  0000              add [bx+si],al
000000D8  2300              and ax,[bx+si]
...
00000120  640F0000          sldt [fs:bx+si]
...
0000012F  00640F            add [si+0xf],ah
00000132  0000              add [bx+si],al
00000134  0100              add [bx+si],ax
...
000001CF  00860F00          add [bp+0xf],al
...
0000021F  00940F00          add [si+0xf],dl
...
0000023F  005F5F            add [bx+0x5f],bl
00000242  65685F66          gs push word 0x665f
00000246  7261              jc 0x2a9
00000248  6D                insw
00000249  650000            add [gs:bx+si],al
...
00000290  1900              sbb [bx+si],ax
00000292  0000              add [bx+si],al
00000294  E80000            call 0x297
00000297  005F5F            add [bx+0x5f],bl
0000029A  44                inc sp
0000029B  41                inc cx
0000029C  54                push sp
0000029D  41                inc cx
...
00000327  005F5F            add [bx+0x5f],bl
0000032A  6C                insb
0000032B  61                popa
0000032C  5F                pop di
0000032D  7379              jnc 0x3a8
0000032F  6D                insw
00000330  626F6C            bound bp,[bx+0x6c]
00000333  5F                pop di
00000334  7074              jo 0x3aa
00000336  7200              jc 0x338
00000338  5F                pop di
00000339  5F                pop di
0000033A  44                inc sp
0000033B  41                inc cx
...
00000377  0019              add [bx+di],bl
00000379  0000              add [bx+si],al
0000037B  004800            add [bx+si+0x0],cl
...
000003BF  0022              add [bp+si],ah
000003C1  0000              add [bx+si],al
000003C3  803000            xor byte [bx+si],0x0
000003C6  0000              add [bx+si],al
000003C8  0020              add [bx+si],ah
000003CA  0000              add [bx+si],al
000003CC  0800              or [bx+si],al
000003CE  0000              add [bx+si],al
000003D0  0820              or [bx+si],ah
000003D2  0000              add [bx+si],al
000003D4  1800              sbb [bx+si],al
...
000003E0  2020              and [bx+si],ah
000003E2  0000              add [bx+si],al
000003E4  1000              adc [bx+si],al
000003E6  0000              add [bx+si],al
000003E8  3020              xor [bx+si],ah
000003EA  0000              add [bx+si],al
000003EC  3000              xor [bx+si],al
000003EE  0000              add [bx+si],al
000003F0  0200              add al,[bx+si]
000003F2  0000              add [bx+si],al
000003F4  1800              sbb [bx+si],al
000003F6  0000              add [bx+si],al
000003F8  682000            push word 0x20
000003FB  0004              add [si],al
000003FD  0000              add [bx+si],al
000003FF  00B82000          add [bx+si+0x20],bh
00000403  0038              add [bx+si],bh
00000405  0000              add [bx+si],al
00000407  000B              add [bp+di],cl
00000409  0000              add [bx+si],al
0000040B  005000            add [bx+si+0x0],dl
...
0000041C  0200              add al,[bx+si]
0000041E  0000              add [bx+si],al
00000420  0200              add al,[bx+si]
...
00000440  A820              test al,0x20
00000442  0000              add [bx+si],al
00000444  0400              add al,0x0
...
0000045B  0020              add [bx+si],ah
0000045D  0000              add [bx+si],al
0000045F  000C              add [si],cl
00000461  0000              add [bx+si],al
00000463  002F              add [bx],ch
00000465  7573              jnz 0x4da
00000467  722F              jc 0x498
00000469  6C                insb
0000046A  69622F6479        imul sp,[bp+si+0x2f],word 0x7964
0000046F  6C                insb
00000470  640000            add [fs:bx+si],al
00000473  0000              add [bx+si],al
00000475  0000              add [bx+si],al
00000477  001B              add [bp+di],bl
00000479  0000              add [bx+si],al
0000047B  0018              add [bx+si],bl
0000047D  0000              add [bx+si],al
0000047F  00DA              add dl,bl
00000481  8930              mov [bx+si],si
00000483  C8893D38          enter 0x3d89,0x38
00000487  9B                wait
00000488  97                xchg ax,di
00000489  2BF7              sub si,di
0000048B  2AEA              sub ch,dl
0000048D  C55012            lds dx,[bx+si+0x12]
00000490  2400              and al,0x0
00000492  0000              add [bx+si],al
00000494  1000              adc [bx+si],al
00000496  0000              add [bx+si],al
00000498  000A              add [bp+si],cl
0000049A  0A00              or al,[bx+si]
0000049C  000A              add [bp+si],cl
0000049E  0A00              or al,[bx+si]
000004A0  2A00              sub al,[bx+si]
000004A2  0000              add [bx+si],al
000004A4  1000              adc [bx+si],al
...
000004B0  2800              sub [bx+si],al
000004B2  00801800          add [bx+si+0x18],al
000004B6  0000              add [bx+si],al
000004B8  40                inc ax
000004B9  0F0000            sldt [bx+si]
...
000004C8  0C00              or al,0x0
000004CA  0000              add [bx+si],al
000004CC  3800              cmp [bx+si],al
000004CE  0000              add [bx+si],al
000004D0  1800              sbb [bx+si],al
000004D2  0000              add [bx+si],al
000004D4  0200              add al,[bx+si]
000004D6  0000              add [bx+si],al
000004D8  0000              add [bx+si],al
000004DA  BD0400            mov bp,0x4
000004DD  0001              add [bx+di],al
000004DF  002F              add [bx],ch
000004E1  7573              jnz 0x556
000004E3  722F              jc 0x514
000004E5  6C                insb
000004E6  69622F6C69        imul sp,[bp+si+0x2f],word 0x696c
000004EB  625379            bound dx,[bp+di+0x79]
000004EE  7374              jnc 0x564
000004F0  656D              gs insw
000004F2  2E42              cs inc dx
000004F4  2E64796C          fs jns 0x564
000004F8  6962000000        imul sp,[bp+si+0x0],word 0x0
000004FD  0000              add [bx+si],al
000004FF  00260000          add [0x0],ah
00000503  0010              add [bx+si],dl
00000505  0000              add [bx+si],al
00000507  006020            add [bx+si+0x20],ah
0000050A  0000              add [bx+si],al
0000050C  0800              or [bx+si],al
0000050E  0000              add [bx+si],al
00000510  2900              sub [bx+si],ax
00000512  0000              add [bx+si],al
00000514  1000              adc [bx+si],al
00000516  0000              add [bx+si],al
00000518  682000            push word 0x20
...
00000F3F  005548            add [di+0x48],dl
00000F42  89E5              mov bp,sp
00000F44  48                dec ax
00000F45  83EC10            sub sp,byte +0x10
00000F48  48                dec ax
00000F49  8D3D              lea di,[di]
00000F4B  37                aaa
00000F4C  0000              add [bx+si],al
00000F4E  00B000E8          add [bx+si+0xe800],dh
00000F52  0E                push cs
00000F53  0000              add [bx+si],al
00000F55  0031              add [bx+di],dh
00000F57  C9                leave
00000F58  8945FC            mov [di-0x4],ax
00000F5B  89C8              mov ax,cx
00000F5D  48                dec ax
00000F5E  83C410            add sp,byte +0x10
00000F61  5D                pop bp
00000F62  C3                ret
00000F63  90                nop
00000F64  FF25              jmp near [di]
00000F66  A6                cmpsb
00000F67  0000              add [bx+si],al
00000F69  0000              add [bx+si],al
00000F6B  004C8D            add [si-0x73],cl
00000F6E  1D9500            sbb ax,0x95
00000F71  0000              add [bx+si],al
00000F73  41                inc cx
00000F74  53                push bx
00000F75  FF25              jmp near [di]
00000F77  8500              test [bx+si],ax
00000F79  0000              add [bx+si],al
00000F7B  90                nop
00000F7C  680000            push word 0x0
00000F7F  0000              add [bx+si],al
00000F81  E9E6FF            jmp 0xf6a
00000F84  FF                db 0xFF
00000F85  FF6865            jmp far [bx+si+0x65]
00000F88  6C                insb
00000F89  6C                insb
00000F8A  6F                outsw
00000F8B  2C20              sub al,0x20
00000F8D  776F              ja 0xffe
00000F8F  726C              jc 0xffd
00000F91  640A00            or al,[fs:bx+si]
00000F94  0100              add [bx+si],ax
00000F96  0000              add [bx+si],al
00000F98  1C00              sbb al,0x0
00000F9A  0000              add [bx+si],al
00000F9C  0000              add [bx+si],al
00000F9E  0000              add [bx+si],al
00000FA0  1C00              sbb al,0x0
00000FA2  0000              add [bx+si],al
00000FA4  0000              add [bx+si],al
00000FA6  0000              add [bx+si],al
00000FA8  1C00              sbb al,0x0
00000FAA  0000              add [bx+si],al
00000FAC  0200              add al,[bx+si]
00000FAE  0000              add [bx+si],al
00000FB0  40                inc ax
00000FB1  0F0000            sldt [bx+si]
00000FB4  3400              xor al,0x0
00000FB6  0000              add [bx+si],al
00000FB8  3400              xor al,0x0
00000FBA  0000              add [bx+si],al
00000FBC  640F0000          sldt [fs:bx+si]
00000FC0  0000              add [bx+si],al
00000FC2  0000              add [bx+si],al
00000FC4  3400              xor al,0x0
00000FC6  0000              add [bx+si],al
00000FC8  0300              add ax,[bx+si]
00000FCA  0000              add [bx+si],al
00000FCC  0C00              or al,0x0
00000FCE  0100              add [bx+si],ax
00000FD0  1000              adc [bx+si],al
00000FD2  0100              add [bx+si],ax
00000FD4  0000              add [bx+si],al
00000FD6  0000              add [bx+si],al
00000FD8  0000              add [bx+si],al
00000FDA  0001              add [bx+di],al
00000FDC  0000              add [bx+si],al
00000FDE  0000              add [bx+si],al
00000FE0  1400              adc al,0x0
00000FE2  0000              add [bx+si],al
00000FE4  0000              add [bx+si],al
00000FE6  0000              add [bx+si],al
00000FE8  037A52            add di,[bp+si+0x52]
00000FEB  0001              add [bx+di],al
00000FED  7810              js 0xfff
00000FEF  0110              add [bx+si],dx
00000FF1  0C07              or al,0x7
00000FF3  08900100          or [bx+si+0x1],dl
...
0000207F  00400F            add [bx+si+0xf],al
